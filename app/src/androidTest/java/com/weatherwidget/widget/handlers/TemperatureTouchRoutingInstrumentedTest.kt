 ...
 * footer switches the widget into CLOUD_COVER mode instead of cycling zoom.
 */
@RunWith(AndroidJUnit4::class)
class TemperatureTouchRoutingInstrumentedTest : IsolatedIntegrationTest("temperature_touch_routing") {

    private lateinit var stateManager: WidgetStateManager
    private val appWidgetId = 913
    ...
    fun bottomFooterTap_switchesFromTemperatureToCloudCover_withoutZooming() = runBlocking {
        ...
        assertEquals(
            "Bottom footer tap should switch to cloud cover mode",
    ...
    private fun buildBottomTapViews(): RemoteViews {
        ...
        val goCloudIntent = Intent(context, WeatherWidgetProvider::class.java).apply {
            ...
            putExtra(EXTRA_TARGET_VIEW, ViewMode.CLOUD_COVER.name)
        }
