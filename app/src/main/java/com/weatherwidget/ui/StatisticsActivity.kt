    ...
    private fun loadStatistics() {
        lifecycleScope.launch {
            try {
                ...
                val nwsDaily = accuracyCalculator.getDailyAccuracyBreakdown("NWS", lat, lon, 30)
                val meteoDaily = accuracyCalculator.getDailyAccuracyBreakdown("Open-Meteo", lat, lon, 30)
