...
object WeatherIconMapper {
    fun getIconResource(
        ...
        return when {
            ...
            lowerCondition.contains("(75%)") || lowerCondition.contains("mostly cloudy") -> {
            ...
            lowerCondition.contains(
                "wind",
            ) || lowerCondition.contains("breez") || lowerCondition.contains("gale") -> R.drawable.ic_weather_wind
            lowerCondition.contains(
                "clear",
            ) || lowerCondition.contains("sunny") || lowerCondition.contains("fair") || lowerCondition.contains("observed") -> {
