...
class WeatherHistoryConditionTest {
    ...
    fun setup() {
        ...
        nwsApi = mockk()
        forecastRepo = ForecastRepository(context, mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true), nwsApi, mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true))
        repository =
            WeatherRepository(
                context,
                forecastRepo,
