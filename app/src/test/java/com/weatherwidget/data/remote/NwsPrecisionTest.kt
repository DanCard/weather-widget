...
class NwsPrecisionTest {
    ...
    @Test
    fun `getHourlyForecast parses float temperatures correctly`() =
        runTest {
    ...
    @Test
    fun `getObservations parses high precision Celsius correctly`() =
        runTest {
    ...
    @Test
    fun `getForecast handles potential float strings for daily high`() =
        runTest {
            val forecastResponse =
                """
                {
